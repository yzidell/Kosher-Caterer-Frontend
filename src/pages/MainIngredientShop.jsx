...
const MainIngredientShop = () => {
    ...
    const sellerMainIngredientTerm = seller.mainIngredientTerm
    ...
    return (
        <div>
            <Header/>
            <ShopBanner homePage={'Home'} homeLink={'/'} currentPageTop={sellerMainIngredientTerm + ' Page'} currentPageTopLink={''} 
                currentPageBottom1={mainIngredient} currentPageBottomLink1={'/productsMainIngredient?mainIngredient=' + mainIngredient} 
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 
                            ...
                            <div className={` ${sellerBoolShowSiteProductsUnderFilter ? '' : 'hidden'} py-5 flex flex-col gap-4 md:hidden`}>
                                <Products title={'Latest '+ sellerProductPluralTerm} products={latest_product}  parentPage={'MainIngredientShop'} />
                            </div> 
                        </div>
...
export default MainIngredientShop;